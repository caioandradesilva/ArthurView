...
interface ASICCostsProps {
  costs: CostRecord[];
  asicId: string;
}

const ASICCosts: React.FC<ASICCostsProps> = ({ costs, asicId }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Total Maintenance Costs</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g., Replacement fan, Labor for repair"
      ...
      {costs.length === 0 ? (
        <div className="text-center py-8">
          ...
          <p className="text-gray-500">Maintenance costs for this ASIC will appear here</p>
        </div>
      ) : (
